          ...
          case TabColumnType.Picture:
            {
              ...
              n.render = function (text) {
                ...
                return _react2.default.createElement(_image2.default, (0, _extends3.default)({}, imgSize, {
                  style: imgSize,
                  imageUrl: text,
                ...
                return {
                  onClick: function onClick() {
                    _modal2.default.info({
                      ...
                      maskClosable: true,
                      okText: "X",
                      content: _react2.default.createElement(_image2.default, {
              ...
              n.render = function (text, record, index) {
                  ...
                  return _react2.default.createElement(
                    _dropdown2.default,
                    {
                      ...
                      overlay: _react2.default.createElement(
                        ...
                        _lodash2.default.map(newBtnGroup, function (vv, kk) {
                          return _react2.default.createElement(
                            _menu2.default.Item,
                            { key: kk },
                            _react2.default.createElement(
                              "a",
                              { className: vv.className, onClick: function onClick() {
                ...
                return _react2.default.createElement(
                  ...
                  _lodash2.default.map(newBtnGroup, function (vv, kk) {
                    return _react2.default.createElement(
                      "a",
                      { key: kk, className: vv.className, onClick: function onClick() {
                          _onClick && _onClick(record, vv, index);
                        } },
                      vv.name
                    );
