          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return (0, _isomorphicFetch2.default)(url, (0, _extends3.default)({}, this.requestInit, { method: 'post', body: (0, _stringify2.default)(body) }));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return (0, _isomorphicFetch2.default)(url, (0, _extends3.default)({}, this.requestInit, { method: 'get' }));
